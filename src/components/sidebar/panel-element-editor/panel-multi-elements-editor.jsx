...
import {
  MODE_IDLE, MODE_MAP2D, MODE_2D_ZOOM_IN, MODE_2D_ZOOM_OUT, MODE_2D_PAN, MODE_3D_VIEW, MODE_3D_FIRST_PERSON,
...
//export default function PanelMultiElementsEditor({state}, {projectActions, translator}) {
  ...
  render() {
    ...
    if (![MODE_IDLE, MODE_MAP2D, MODE_2D_ZOOM_IN, MODE_2D_ZOOM_OUT, MODE_2D_PAN,
