...
export default function Map2D(
  { state, width, height },
  { map2DActions, linesActions, holesActions, verticesActions, itemsActions, areaActions, projectActions, catalog }) {
  ...
  let onChangeValue = (value) => {
    ...
    return map2DActions.updateCameraView(value)
  };
  ...
  let onChangeTool = (tool) => {
    switch (tool) {
      ...
      case TOOL_PAN:
        map2DActions.selectToolPan();
        break;

      case TOOL_ZOOM_IN:
        map2DActions.selectToolZoomIn();
        break;

      case TOOL_ZOOM_OUT:
        map2DActions.selectToolZoomOut();
        break;
    }
  };

  let { e, f, SVGWidth, SVGHeight } = state.get('map2D').toJS();
  ...
  return (
    <div style={{
      ...
      <ReactSVGPanZoom
        ...
        width={width - rulerSize}
        height={height - rulerSize}
        value={map2D.isEmpty() ? null : map2D.toJS()}
