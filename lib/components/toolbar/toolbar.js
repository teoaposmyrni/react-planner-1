    ...
    value: function render() {
      ...
      },
      {
        ...
        index: 9, condition: true, dom: _react2.default.createElement(
          _toolbarButton2.default,
          {
            active: [_constants.MODE_MAP2D].includes(mode),
            tooltip: translator.t('2D Map'),
            onClick: function onClick(event) {
              return projectActions.setMode(_constants.MODE_MAP2D);
            } },
          [_constants.MODE_3D_FIRST_PERSON, _constants.MODE_3D_VIEW, _constants.MODE_IDLE].includes(mode) ? _react2.default.createElement(Icon2D, { style: { color: alterateColor } }) : _react2.default.createElement(_fa.FaMousePointer, { style: { color: alterateColor } })
        )
      }];
